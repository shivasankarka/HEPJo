...
#     var test2 = Vector2D[i32](test1.data)
#     for i in range(2):
...
# def test_str():
#     var test1 = Vector2D[i32](1, 2)
#     assert_true(str(test1)=="Vector2D: [1 , 2]; dtype=int32", "__str__ doesn't work")

# def test_repr():
#     var test1 = Vector2D[i32](1, 2)
#     assert_true(test1.__repr__()=="Vector2D[DType.int32](x=1, y=2)", "__repr__ doesn't work")
...
# def test_store():
#     var vec = Vector2D[i32](1, 2)
#     vec.store(0, SIMD[i32, 1](3))
#     vec.store(1, SIMD[i32, 1](4))
#     assert_true(vec[0] == 3, "store failed at index 0")
#     assert_true(vec[1] == 4, "store failed at index 1")
